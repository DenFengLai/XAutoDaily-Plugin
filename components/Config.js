...
import { Path, Plugin_Path, Plugin_Name } from "../constants/Path.js"
...
class Config {
  ...
  initCfg() {
    ...
    for (let file of files) {
      ...
      if (fs.existsSync(userFilePath)) {
        ...
        for (const [ key, value ] of Object.entries(userYaml.jsonData)) mergedYaml.set(key, value)
      }
  ...
  watch(file, name, type = "default_config") {
    ...
    watcher.on("change", path => {
      ...
      logger.mark(`[${Plugin_Name}][修改配置文件][${type}][${name}]`)
